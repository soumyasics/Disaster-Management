...
function Allrescueteam() {
    ...
    const fetchAllRescueMembers = () => {
        axiosInstance.post(`viewallresquemembers`)
            .then((res) => {
                console.log(res);
    ...
    const handleSearch = (e) => {
        ...
        if (value.trim() === '') {
            ...
            axiosInstance.post(`searchrescueByName/${value}`)
                .then((res) => {
                    console.log(res);
                    setData(res.data);
                })
    ...
    return (
        <div className='container'>
            ...
            <div className='allusers-mainboxhead'>
                <p className='allusers-mainboxppp'>All Rescue Members</p>
