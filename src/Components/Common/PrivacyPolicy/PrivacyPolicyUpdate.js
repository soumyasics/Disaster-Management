...
import '../../Common/PrivacyPolicy/PrivacypolicyUpdate.css'
                ...
                <div className='col-lg-8 col-md-8 col-sm-8'>
                    ...
                    <div className='row border shadow-lg rounded-4 mb-5'>
                        <div className='col-lg-12 col-md-8 col-sm-8 p-3'>
                            <p className='ps-5 mt-5 d-flex privacy_head_text'>Privacy policy description</p>
                            <div className='continer mt-3 ms-5 mx-5 rounded-4 border border-success-subtle border-4 p-4'>
                                <p className='lh-base Privacy_body_text'>A privacy policy is a statement or legal document that outlines how an organization collects, uses, discloses, and manages a customer's or client's data. It
                                    serves to inform users about the specific details regarding their privacy rights and the company's practices. Here are the key components typically found in a privacy policy:</p>
                            ...
                            <div className='d-flex justify-content-center mt-3'><button className='Privacy_btn_bg privacy_btn-text'>Save</button></div>
