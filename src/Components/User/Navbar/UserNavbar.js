        ...
        <div>
          ...
          <div className="collapse navbar-collapse" id="navbarNav">
            <ul className="navbar-nav ml-auto padding-links">
              ...
              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
              <li className="nav-item">
                <Link className="nav-link list-items-style" to={`/user_addalerts/${usersId}`}>Add Alerts</Link>
              </li>
              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
              <li className="nav-item">
              ...
              <li className="nav-item dropdown">
                ...
                <ul className="dropdown-menu dropment" aria-labelledby="navbarDropdown">
                  ...
                  <li className='dropmentli'><Link className="dropdown-item" to="">Profile</Link></li>
                  <li className='dropmentli'><Link className="dropdown-item" to="">Logout</Link></li>
                </ul>
              </li>
            </ul>
          </div>
