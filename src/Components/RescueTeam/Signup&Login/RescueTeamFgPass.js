...
<h1>Rescue Person Reset Password</h1>
...
<h2>OR</h2>
<h3>YOU HAVE'NT ACCOUNT ? <Link to="/rescueperson_signup"><span>CREATE ONE</span></Link></h3>
</div>
    </div>
...
export default RescueTeamFgPass